...
public class ValidadorArgumento {
    ...
    public static void validarLongitudMinima(Object valor, double longitudMinima, String mensaje) {
    ...
    public static void validarDistanciaMinima(float distanciaRecorrido, float distanciaMinima, String mensaje){
        if(distanciaMinima > distanciaRecorrido){
            throw new ExcepcionValorInvalido(mensaje);
        }
    }

    public static void validarObligatorioDistancia(float distanciaRecorrido, String mensaje){
        if(distanciaRecorrido == 0){
            throw new ExcepcionValorObligatorio(mensaje);
        }
    }

    public static void validarDistanciaMaxima(float distanciaRecorrido, float distanciaMaxima, String mensaje){
        if(distanciaRecorrido > distanciaMaxima){
            throw new ExcepcionValorInvalido(mensaje);
        }
    }

    public static void validarDatoIdUsuario(Long idUsuario,String mensaje){
